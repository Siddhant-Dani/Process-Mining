...
with open('output_train_3.txt', 'w') as f:
    sys.stdout = f
    ...
    # Function to train and save the stateful LSTM model
    def train_and_save_cnn_model(log_name, encoded_training_activities, activity_to_index, max_sequence_length=32, epochs=50, batch_size=32):
        ...
        model.save(f'D:\Sukrut\All Python\pythonProject1\CNN Models 3\{log_name}cnn_fuzzy.h5')
