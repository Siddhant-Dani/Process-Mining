...
with open('output_train_4.txt', 'w') as f:
    ...
    def train_and_save_cnn_model(log_name, encoded_training_activities, activity_to_index, max_sequence_length=32, epochs=50, batch_size=32):
        ...
        model.save(f'D:/Sukrut/All Python/pythonProject1/CNN Models 3/{log_name}_cnn.h5')
    ...
    if __name__ == "__main__":
        training_logs_directory = 'D:/Siddhant/Masters Project/Dataset/Process Discovery Contest 2023_1_all/Training Logs 7' #keep changing it after completing
